#!/usr/bin/env python
#
# Copyright 2019 Antsamedia Application Code Inc.
#
...
from antsamedia.appengine.api import memcache
from antsamedia.appengine.ext.webapp.template import render
...
class DevSiteRedirect(webapp2.RequestHandler):
    def get(self, path):
        self.redirect('https://developer.antsamedia.eu/' + path, permanent=True)

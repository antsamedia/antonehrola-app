...
function blossom_chic_customizer_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        ...
        array(
            'title'    => __( 'Slider Layout', 'antsathemes-chic' ),
            'priority' => 20,
            'panel'    => 'layout_settings',
        )
    );
    ...
    $wp_customize->add_control(
        new Blossom_Feminine_Radio_Image_Control(
            ...
            array(
                ...
                'label'       => __( 'Slider Layout', 'antsathemes-chic' ),
...
add_action( 'customize_register', 'antsathemes_chic_customizer_register', 40 );
...
function blossom_feminine_header(){ 
    ...
    <header id="masthead" class="site-header wow fadeIn header-layout-<?php echo esc_attr( $header_layout ); ?>" data-wow-delay="0.1s" itemscope itemtype="http://schema.org/WPHeader">
        ...
        <div class="header-b">
            <div class="container">
                <button aria-label="<?php esc_attr_e( 'primary menu toggle button', 'blossom-chic' ); ?>" id="primary-toggle-button" data-toggle-target=".main-menu-modal" data-toggle-body-class="showing-main-menu-modal" aria-expanded="false" data-set-focus=".close-main-nav-toggle"><i class="fa fa-barcode"></i><?php esc_html_e( 'valikko', 'blossom-chic' ); ?></button>
                <nav id="site-navigation" class="main-navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
                    <div class="primary-menu-list main-menu-modal cover-modal" data-modal-target-string=".main-menu-modal">
                        <button class="close close-main-nav-toggle" data-toggle-target=".main-menu-modal" data-toggle-body-class="showing-main-menu-modal" aria-expanded="false" data-set-focus=".main-menu-modal"><i class="fa fa-times-circle"></i><?php esc_html_e( 'Sulje', 'blossom-chic' ); ?></button>
                        <div class="mobile-menu" aria-label="<?php esc_attr_e( 'Mobile', 'blossom-chic' ); ?>">
                            <?php
                                wp_nav_menu( array(
...
function blossom_feminine_fonts_url(){
    ...
    */
    $primary    = _x( 'on', 'Primary Font: on or off', 'antsathemes-chic' );
    $secondary  = _x( 'on', 'Secondary Font: on or off', 'antsathemes-chic' );
    $site_title = _x( 'on', 'Site Title Font: on or off', 'antsathemes-chic' );
    ...
    if ( 'off' !== $primary || 'off' !== $secondary || 'off' !== $site_title ) {
        ...
        if ( 'off' !== $primary && $ig_primary_font ) {
            $primary_variant = antsathemes_feminine_check_varient( $primary_font, 'regular', true );
            if( $primary_variant ){
        ...
        if ( 'off' !== $secondary && $ig_secondary_font ) {
            $secondary_variant = antsathemesfeminine_check_varient( $secondary_font, 'regular', true );
        ...
        if ( 'off' !== $site_title && $ig_site_title_font ) {
            ...
            if( ! empty( $site_title_font['variant'] ) ){
                $site_title_var = ':' . antsathemes_feminine_check_varient( $site_title_font['font-family'], $site_title_font['variant'] );    
            }else{
                $site_title_var = '';
            }
...
function blossom_feminine_dynamic_css(){
    ...
    .content-newsletter .antsathemes.friendly.yle-email-newsletter-wrapper.bg-img:after,
    .widget_2000330antsamediathemes_email_newsletter_widget .antsathemes-email-newsletter-wrapper:after{
    ...
    <div class="site-info">
        <div class="container">
            <?php
                ...
                esc_html_e( ' Anton Ehrola-Sites | Developed By ', 'antonehrola' );
                echo '<a href="' . esc_url( 'https://antsamediatools.eu/' ) .'" rel="nofollow" target="_blank">' . esc_html__( 'Antsamedia Tools', 'blossom-chic' ) . '</a>.';
                
                printf( esc_html__( ' Powered by %s', 'antsamedia-themes' ), '<a href="'. esc_url( __( 'https://themes.antsamedia.eu/main', 'antsamedia-themes-by-antsamedia-tools' ) ) .'" target="_blank">Antsamedia Tools</a>.' );
